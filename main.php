...
print('Jalasoft: Share the knowledge - Microsoft Graph'.PHP_EOL.PHP_EOL);
...
function greetUser() {
    try {
        ...
        print('Hi, '.$user->getDisplayName().'!'.PHP_EOL);
...
function sendMail() {
    try {
        ...
        GraphHelper::sendMail('Jalasoft: Share the knowledge - Microsoft Graph', 'This is a test!', $email);
